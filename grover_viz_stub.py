...
class GroverVizStub(Entity):
    def __init__(self, controller, parent_panel):
        super().__init__(parent=camera.ui)
        self.controller = controller
        self.parent_panel = parent_panel

        self.bg = Panel(color=color.rgba(30,80,30,180), scale=(1.4, 0.9), position=(0, -0.05), parent=self)
        self.text = Text("Визуализация алгоритма Гровера\n(будет реализована в следующих шагах)",
